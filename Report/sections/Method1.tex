...
The structure of this project's Decision Tree implementation follows a classic object oriented design. It is constructed with nodes witch function as either:\\
leaf - which holds the prediction\\
decision node - which holds the splitting rule (the feature and threshold) as well as pointers to it's left and right children.\\
\\
